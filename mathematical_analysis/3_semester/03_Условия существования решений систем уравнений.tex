...
|y - y_0| &< b
\end{aligned}
\right.$ такой, что в нем уравнение $F(x, y) = 0$ однозначным образом определяет неявную непрерывную и непрерывно-дифференцируемую функцию $y = f(x)$ на интервале $x \in (x_0 - a, x_0 + a)$.
