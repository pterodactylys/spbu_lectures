...
|y - y_0| &< b
\end{aligned}
\right.$ такой, что в нем уравнение $y = f(x)$ однозначным образом определяет неявную непрерывную и непрерывно-дифференцируемую функцию на интервале $x \in (x_0 - a, x_0 + a)$.
