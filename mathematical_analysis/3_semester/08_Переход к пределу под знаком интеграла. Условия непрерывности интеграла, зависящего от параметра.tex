...
то по критерию Римана следует, что $\exists \int_a^b \varphi(x) \, dx$.
...
Так как $[a,b] \times [c,d]$ — замкнутое непрерывное множество, и $f$ непрерывна на нём, то по теореме Кантора (о равномерной непрерывности на компакте):
